...
plt.hist(chi_p_INC_50,50, facecolor='r', normed=True)
plt.hist(chi_p_INC_60,50, facecolor='m', normed=True)
plt.hist(chi_p_INC_70,50, facecolor='g', normed=True)
plt.hist(chi_p_INC_80,50, facecolor='b', normed=True)
