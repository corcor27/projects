...
plt.hist(chi_p_INC_10,50, facecolor='g', normed=True)
plt.hist(chi_p_INC_20,50, facecolor='b', normed=True)
plt.hist(chi_p_INC_30,50, facecolor='c', normed=True)
plt.hist(chi_p_INC_40,50, facecolor='y', normed=True)
plt.hist(chi_p_INC_50,50, facecolor='grey', normed=True)
plt.hist(chi_p_INC_60,50, facecolor='lightgreen', normed=True)
plt.hist(chi_p_INC_70,50, facecolor='skyblue', normed=True)
plt.hist(chi_p_INC_80,50, facecolor='lightcoral', normed=True)
